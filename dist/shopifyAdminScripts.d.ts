...
export declare const addBadAddressTags: (shopifyOrder: ShopifyOrderObject) => Promise<[void]>;
export declare const updateShippingAddressInShopify: (shopifyOrder: ShopifyOrderObject) => Promise<void>;
 ...
 */
export declare const addCountryTagToCustomerInShopify: (shopifyOrder: ShopifyOrderObject) => Promise<void>;
...
export declare const megaRewardsTest: (shopifyOrder: ShopifyOrderObject) => Promise<void>;
